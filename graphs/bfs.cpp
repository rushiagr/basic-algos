...
/* Coloured graph means graph has a colour attribute. White means unvisited,
 * grey means in process I guess, and black means visited. This is one
 * approach. Another method is just maintaining a list of visited nodes.
 */
