...
/* Note this is not full knapsack. It only checks the optimal value if the
 capacity is 'exactly' the capacity variable. In practice, *you should run this
 algorithm for i = 1 to capacity */
